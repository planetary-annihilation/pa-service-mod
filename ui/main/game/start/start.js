...
// try to set game type, mod identifiers and uuid if we have matching reconnect info
        ...
        // Local news posts are supplied by ui/mods/pa-service-mod/inject.js, which runs from
        // loadSceneMods('start') at the end of this file. Shown first; de-duped by url.
        self.FEATURED_NEWS = [];
        ...
        // Events are supplied by ui/mods/pa-service-mod/inject.js, which takes over
        // fetchAnnouncements() below.
